...
patch_size = [48, 256, 256] # for coarse- and fine-seg
...
data = dict(
    ...
    train=dict(
        ...
        data_root='./checkpoints/predata_lung',
        patch_size=patch_size,
        sample_frequent=10,
        win_level=win_level,
        win_width=win_width,
    ...
    test=dict(
        type='Cls25DSampleDataset', 
        dst_list_file='./checkpoints/predata/test.lst',
        data_root='./checkpoints/predata_lung',
        patch_size=patch_size,
        sample_frequent=1,
        win_level=win_level,
...
load_from = None
work_dir = './checkpoints/results/Cls25D_fold0_resnet34'
