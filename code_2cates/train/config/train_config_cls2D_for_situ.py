...
data = dict(
    ...
    train=dict(
        ...
        # dst_list_file='/home/tx-deepocean/workspace_ccc/Project/ShangHaiFeiKe_prognosis/preprocess/data_split/situ_train_pids.lst',
        dst_list_file='/home/tx-deepocean/workspace_ccc/Project/ShangHaiFeiKe_prognosis/preprocess/predata_level2_margin_tdot9_sttd/situ_train_patches.lst',
    ...
    val=dict(
        type='Cls2DSampleDataset', 
        # dst_list_file='/home/tx-deepocean/workspace_ccc/Project/ShangHaiFeiKe_prognosis/preprocess/data_split/situ_test_pids.lst',
        dst_list_file='/home/tx-deepocean/workspace_ccc/Project/ShangHaiFeiKe_prognosis/preprocess/predata_level2_margin_tdot9_sttd/situ_test_patches.lst',
        data_root='/home/tx-deepocean/workspace_ccc/Project/ShangHaiFeiKe_prognosis/preprocess/predata_level2_margin_tdot9_sttd',
        patch_size=patch_size,
        # sample_frequent=500,
        sample_frequent=1,
...
load_from = None
work_dir = './checkpoints/results_for_situ_0222/'
